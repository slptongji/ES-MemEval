...
from lib.shared.prompt_strategies.round_wise_memory_inplace_strategy import RoundWiseMemoryInplaceStrategy
...
def memory(parameters: QaExperimentParameters.MemoryStrategyParameters):
    ...
    store: DocumentStore = VectorDocumentStore(15, "FAISS", embedding)
    strategy: PromptStrategy = RoundWiseMemoryInplaceStrategy(store)
    return strategy
