...
def room(parameters: DgExperimentParameters.SupporterChatRoomParameters) -> ChatRoom:
    ...
    room.append(SystemMessage("The following dialogue happens now. (You are a baseline with no memory. You cannot recall anything from before. Do not fabricate or deceive.)"))
    room.append(parameters.beginning_prompt)
    return room
...
if __name__ == "__main__":
    class Config:
        ...
        supporter_model: ChatModelIndicator = common_configurations.gpt35turbo
