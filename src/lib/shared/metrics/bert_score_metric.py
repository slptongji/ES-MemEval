...
class BertScoreMetric(Metric[str, str, Any]):
    def __init__(self, 
                 cuda: bool,
    ...
    def compute(self, gold: str, prediction: str, more: Any = None) -> dict[str, float | str]:
...
def _test():
    print(BertScoreMetric(False).compute("Hello World", "Hi Peter"))
